...
<img src="https://wiki.wecash.net/download/attachments/18786187/direct.png?version=1&modificationDate=1536765400700&api=v2" width=500 height=300 />
...
能和direct交换机一样。
<img src="https://wiki.wecash.net/download/attachments/18786187/topic.png?version=1&modificationDate=1536765408838&api=v2" width=500 height=300 />

#### FANOUT交换机

fanout：不处理路由键。只需要简单的将队列绑定到交换机上。一个发送到交换机的消息都会以广播的形式被转发到与该交换机绑定的所有队列上。每个
绑定的队里都得到一份复制的消息。fanout类型交换机转发消息是最快的。
<img src="https://wiki.wecash.net/download/attachments/18786187/exchange.png?version=1&modificationDate=1536765405135&api=v2" width=500 height=300 />
